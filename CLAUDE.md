...
- Tests: **TUnit**, for `ValueRanker.Core` only (domain logic and use cases via in-memory fakes of the ports). No UI tests and no automated tests for adapters in this iteration.
